...
type UsergroupAdminApiService service

/*
UsergroupAdminApiService
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param body

@return AddAccountsToUserGroupResponse
*/
func (a *UsergroupAdminApiService) AddAccountsToGroup1(ctx context.Context, body AddAccountsToUserGroupRequest) (AddAccountsToUserGroupResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/add-accounts"
...
*/
func (a *UsergroupAdminApiService) AttachPolicyToUserGroup1(ctx context.Context, body AttachPolicyToUserGroupRequest) (AttachPolicyToUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/attach-policies"
...
*/
func (a *UsergroupAdminApiService) DeleteUserGroupByGroupId1(ctx context.Context, userGroupId string) (DeleteUserGroupResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/{userGroupId}"
...
*/
func (a *UsergroupAdminApiService) DetachPoliciesFromUserGroup1(ctx context.Context, body DetachPolicyFromUserGroupRequest) (DetachPolicyFromUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/detach-policies"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *UsergroupAdminApiGetAllGroupUserBelong1Opts - Optional Parameters:
...
type UsergroupAdminApiGetAllGroupUserBelong1Opts struct {
...
func (a *UsergroupAdminApiService) GetAllGroupUserBelong1(ctx context.Context, accountId string, localVarOptionals *UsergroupAdminApiGetAllGroupUserBelong1Opts) (GetAllGroupUserBelongResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/has-account/{accountId}"
...
*/
func (a *UsergroupAdminApiService) GetDetailUserGroupResponse1(ctx context.Context, userGroupId string) (GetDetailUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *UsergroupAdminApiGetGroupUserAccountNotIn1Opts - Optional Parameters:
     * @param "Name" (optional.String) -
     * @param "PageIndex" (optional.Int32) -  Zero-based page index (0..N)
     * @param "PageSize" (optional.Int32) -  The size of the page to be returned
     * @param "Sort" (optional.Interface of []string) -  Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
...
type UsergroupAdminApiGetGroupUserAccountNotIn1Opts struct {
	Name      optional.String
	PageIndex optional.Int32
	PageSize  optional.Int32
	Sort      optional.Interface
...
func (a *UsergroupAdminApiService) GetGroupUserAccountNotIn1(ctx context.Context, accountId string, localVarOptionals *UsergroupAdminApiGetGroupUserAccountNotIn1Opts) (GetAllUserGroupsNotInAccountResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/account-not-in/{accountId}"
	localVarPath = strings.Replace(localVarPath, "{"+"accountId"+"}", fmt.Sprintf("%v", accountId), -1)
...
UsergroupAdminApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *UsergroupAdminApiGetUserGroupByUserId1Opts - Optional Parameters:
...
type UsergroupAdminApiGetUserGroupByUserId1Opts struct {
...
func (a *UsergroupAdminApiService) GetUserGroupByUserId1(ctx context.Context, localVarOptionals *UsergroupAdminApiGetUserGroupByUserId1Opts) (GetAllUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group"
...
*/
func (a *UsergroupAdminApiService) RemoveAccounts1(ctx context.Context, body RemoveAccountsUserGroupRequest) (RemoveAccountsUserGroupResponses, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/user-group/remove-accounts"
...
*/
func (a *UsergroupAdminApiService) SaveUserGroup1(ctx context.Context, body SaveUserGroupRequest) (SaveUserGroupResponse, *http.Response, error) {
	var (
...
*/
func (a *UsergroupAdminApiService) UpdateUserGroup1(ctx context.Context, body UpdateUserGroupRequest) (UpdateUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
