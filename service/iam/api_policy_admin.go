...
type PolicyAdminApiService service

/*
PolicyAdminApiService
  - @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
  - @param policyId

@return ActivePolicyResponse
*/
func (a *PolicyAdminApiService) ActivePolicyByPolicyId(ctx context.Context, policyId string) (ActivePolicyResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue ActivePolicyResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/active/{policyId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *PolicyAdminApiGetAllInlinePoliciesByAccount1Opts - Optional Parameters:
...
type PolicyAdminApiGetAllInlinePoliciesByAccount1Opts struct {
...
func (a *PolicyAdminApiService) GetAllInlinePoliciesByAccount1(ctx context.Context, accountId string, localVarOptionals *PolicyAdminApiGetAllInlinePoliciesByAccount1Opts) (GetAllInlinePoliciesByAccountResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/inline/{accountId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userGroupId
 * @param optional nil or *PolicyAdminApiGetAllPolicyBelongToUserGroup1Opts - Optional Parameters:
     * @param "Name" (optional.String) -
     * @param "PageIndex" (optional.Int32) -  Zero-based page index (0..N)
     * @param "PageSize" (optional.Int32) -  The size of the page to be returned
     * @param "Sort" (optional.Interface of []string) -  Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
...
type PolicyAdminApiGetAllPolicyBelongToUserGroup1Opts struct {
	Name      optional.String
	PageIndex optional.Int32
	PageSize  optional.Int32
	Sort      optional.Interface
...
func (a *PolicyAdminApiService) GetAllPolicyBelongToUserGroup1(ctx context.Context, userGroupId string, localVarOptionals *PolicyAdminApiGetAllPolicyBelongToUserGroup1Opts) (GetAllPolicyBelongToUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/belong-to-user-group/{userGroupId}"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param userGroupId
 * @param optional nil or *PolicyAdminApiGetAllPolicyNotIn1Opts - Optional Parameters:
     * @param "Name" (optional.String) -
     * @param "PageIndex" (optional.Int32) -  Zero-based page index (0..N)
     * @param "PageSize" (optional.Int32) -  The size of the page to be returned
     * @param "Sort" (optional.Interface of []string) -  Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
...
type PolicyAdminApiGetAllPolicyNotIn1Opts struct {
	Name      optional.String
	PageIndex optional.Int32
	PageSize  optional.Int32
	Sort      optional.Interface
...
func (a *PolicyAdminApiService) GetAllPolicyNotIn1(ctx context.Context, userGroupId string, localVarOptionals *PolicyAdminApiGetAllPolicyNotIn1Opts) (GetAllPoliciesNotInUserGroupResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/not-in-group/{userGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"userGroupId"+"}", fmt.Sprintf("%v", userGroupId), -1)
...
PolicyAdminApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyAdminApiGetAllStaticPolicy1Opts - Optional Parameters:
...
type PolicyAdminApiGetAllStaticPolicy1Opts struct {
...
func (a *PolicyAdminApiService) GetAllStaticPolicy1(ctx context.Context, localVarOptionals *PolicyAdminApiGetAllStaticPolicy1Opts) (GetAllStaticPolicyResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/static"
...
@return GetDetailPolicyAdminResponse
*/
func (a *PolicyAdminApiService) GetDetailPolicyResponse1(ctx context.Context, policyId string) (GetDetailPolicyAdminResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue GetDetailPolicyAdminResponse
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/{policyId}"
	localVarPath = strings.Replace(localVarPath, "{"+"policyId"+"}", fmt.Sprintf("%v", policyId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v GetDetailPolicyAdminResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param accountId
 * @param optional nil or *PolicyAdminApiGetPoliciesAccountNotHas1Opts - Optional Parameters:
     * @param "Name" (optional.String) -
     * @param "PageIndex" (optional.Int32) -  Zero-based page index (0..N)
     * @param "PageSize" (optional.Int32) -  The size of the page to be returned
     * @param "Sort" (optional.Interface of []string) -  Sorting criteria in the format: property,(asc|desc). Default sort order is ascending. Multiple sort criteria are supported.
...
type PolicyAdminApiGetPoliciesAccountNotHas1Opts struct {
	Name      optional.String
	PageIndex optional.Int32
	PageSize  optional.Int32
	Sort      optional.Interface
...
func (a *PolicyAdminApiService) GetPoliciesAccountNotHas1(ctx context.Context, accountId string, localVarOptionals *PolicyAdminApiGetPoliciesAccountNotHas1Opts) (GetAllPoliciesNotInAccountResponses, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/account-not-has/{accountId}"
	localVarPath = strings.Replace(localVarPath, "{"+"accountId"+"}", fmt.Sprintf("%v", accountId), -1)
...
PolicyAdminApiService
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PolicyAdminApiGetPolicyByUser1Opts - Optional Parameters:
     * @param "DomainIdContains" (optional.String) -
     * @param "DomainIdDoesNotContain" (optional.String) -
     * @param "DomainIdEquals" (optional.String) -
     * @param "DomainIdNotEquals" (optional.String) -
...
type PolicyAdminApiGetPolicyByUser1Opts struct {
	DomainIdContains          optional.String
	DomainIdDoesNotContain    optional.String
	DomainIdEquals            optional.String
	DomainIdNotEquals         optional.String
...
func (a *PolicyAdminApiService) GetPolicyByUser1(ctx context.Context, localVarOptionals *PolicyAdminApiGetPolicyByUser1Opts) (GetPoliciesByUserResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/custom"
...
@return ActivePolicyResponse
*/
func (a *PolicyAdminApiService) InactivePolicyByPolicyId(ctx context.Context, policyId string) (ActivePolicyResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy/inactive/{policyId}"
	localVarPath = strings.Replace(localVarPath, "{"+"policyId"+"}", fmt.Sprintf("%v", policyId), -1)
...
*/
func (a *PolicyAdminApiService) SavePolicy1(ctx context.Context, body SavePolicyRequest) (SavePolicyResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/api/v1/admin/policy"
...
*/
func (a *PolicyAdminApiService) UpdatePolicy1(ctx context.Context, body UpdatePolicyRequest) (UpdatePolicyResponse, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Put")
		localVarPostBody    interface{}
		localVarFileName    string
